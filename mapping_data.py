...
for data in all_data:
    ...
    data.loc[data['Fare'] <= 64, 'Fare'] = 4

# Feature 5 Feature Selection
# 5.1 Create List Column To Drop
drop_elements = ["Name", "Ticket", "Cabin", "SibSp", "Parch", "family_size"]

# 5.2 Drop Column From Both Datasets
...
submission.to_csv('titanic_predict_submission.csv', index=False)
